...
static final String USERNAME = "COMP228_w22_sy_48";
...
public void openConnection()
{
  try {
  	// load the driver class
	    ...
	    connection = DriverManager.getConnection( DATABASE_URL, "COMP228_w22_sy_48", "password" );
...
public void updateRow(String record[])
{
    ...
    try 
    {
  	  	...
  	  	for(int i=2; i<= nCols; i++)
          {
  	  	...
  	  	//set the value for playerid parameter
